...
public class extraction {
    ...
    static void extraction(BufferedImage waterMarkedImg, int height, int width, BufferedImage extractedImg, int[] estimator_position, String extractedMsg, int exMsgLength) {
...
//                System.out.println(" p1 : "+p1 + "| p2 : " + p2 + "| p3 : " + p3 + "| p4 : " + p4);
       ...
       extractedMsg= binaryToText(extractedMsg);
        System.out.println(extractedMsg);
    }
}
