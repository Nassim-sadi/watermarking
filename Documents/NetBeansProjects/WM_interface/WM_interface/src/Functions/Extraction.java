...
public class Extraction {
    ...
    public void extraction(BufferedImage waterMarkedImg, int height, int width, BufferedImage extractedImg, int[] estimator_position, String extractedMsg, int exMsgLength) {
